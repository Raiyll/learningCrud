                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form action="{{ route('kategori.destroy', $r->id) }}" method="POST" class="flex gap-2">
                            <a href="{{ route('kategori.show', $r->id) }}" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 text-sm">Detail</a>
                            <a href="{{ route('kategori.edit', $r->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600 text-sm">Edit</a>
                            @csrf
                            @method('DELETE')
